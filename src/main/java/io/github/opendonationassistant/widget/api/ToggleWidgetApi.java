...
public interface ToggleWidgetApi {
  ...
  @RequestBody(content = @Content(schema = @Schema(implementation = ToogleWidgetRequest.class)))
  @ApiResponse(responseCode = "200", description = "Widget toggled successfully", content = @Content(schema = @Schema(implementation = WidgetDto.class)))
  @ApiResponse(responseCode = "401", description = "Unauthorized")
  @ApiResponse(responseCode = "404", description = "Widget not found")
  @Post("/widgets/commands/toggle")
  @Secured(SecurityRule.IS_AUTHENTICATED)
  HttpResponse<WidgetDto> toggleWidget(Authentication auth, @Body ToogleWidgetRequest request);
